...
def main():
    ...
    while True:
        ...
        if eth_proto == 8: # ipv4
            ...
            print(TAB_2 + 'Version: {}, Header Lenghth: {}, TTL, {}'.format(version, header_length, ttl))
            ...
            # TCP
                ...
                print(TAB_2 + 'Source Port: {}, Destination Port: {}, Length:{}'.format(src_port, dest_mac, length))
